...
from envs.smacv2.smac_maps import get_map_params
...
class StarCraft2Env(MultiAgentEnv):
    ...
    def reset(self, episode_config={}):
        ...
        try:
            ...
            is_seccess_init4unit = self.init_units(
        ...
        if is_seccess_init4unit:
            return self.get_obs(), self.get_state(), is_seccess_init4unit
        else:
            return None, None, is_seccess_init4unit
    ...
    def get_alive_agent(self):
        """Returns the list of alive agents."""
        alive_agents = np.ones(self.n_agents)
    ...
    def init_units(self, ally_team, enemy_team, episode_config={}):
        ...
        logging.info("waited for units to spawn and they didn't")
        return False
